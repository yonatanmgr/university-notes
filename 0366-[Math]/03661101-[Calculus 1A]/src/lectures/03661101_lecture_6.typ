...
== משפטים
=== (משפט) תהי $(an)$ סדרה מונוטונית עולה וחסומה מלמעלה. אזי, $exists lim an=sup an$. אם $(an)$ מונוטונית יורדת וחסומה מלמטה, אז $exists lim an = inf an$.
==== הוכחה
...
=== (טענה) סדרה $(an)$ מונוטונית עולה ולא חסומה מלמעלה מתכנסת ל-$+oo$. בדומה, סדרה $(an)$ מונוטונית יורדת ולא חסומה מלמטה מתכנסת ל-$-oo$.

#pagebreak()
== סדרה השואפת ל-$e$
=== (טענה) הסדרה $an = (1+ 1/n)^n$ מונוטונית עולה וחסומה.
...
=== (מסקנה) הסדרה $an$ עולה וחסומה מלמעלה, לכן $exists lim (1+1/n)^n$. מסמנים את הגבול ב-$e$ ($2<=e<=3$). 
